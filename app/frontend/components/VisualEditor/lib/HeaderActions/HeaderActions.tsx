...
import { EDITOR_SAVE_STATUS, type EditorSaveStatus, type PuckSlideData } from "../EditorSave/editorPersistence"
...
const saveStatusColors = {
	[EDITOR_SAVE_STATUS.saved]: "green",
	[EDITOR_SAVE_STATUS.unsaved]: "yellow",
	[EDITOR_SAVE_STATUS.recovered]: "orange",
...
export function HeaderActions() {
	...
	const isDirty = ui.saveStatus !== EDITOR_SAVE_STATUS.saved
	const badgeStatus = ui.isSaving ? EDITOR_SAVE_STATUS.unsaved : ui.saveStatus
