...
describe("components/VisualEditor/fields/spacing/style", () => {
	...
	test("defaults missing spacing units to pixels", () => {
		expect(buildSpacingStyle({
			spacing: {
	...
	test("reads margin and padding from the spacing object", () => {
...
describe("components/VisualEditor/config root spacing", () => {
