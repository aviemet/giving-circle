class Presentations::ElementsController < ApplicationController
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements (theme_presentation_elements)
  def index
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements/:id (theme_presentation_element)
  def show
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements/new (new_theme_presentation_element)
  def new
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements/:id/edit (edit_theme_presentation_element)
  def edit
    authorize presentation_element
  ...
  # @route POST /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements (theme_presentation_elements)
  def create
    authorize Presentation::Element.new
  ...
  # @route PATCH /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements/:id (theme_presentation_element)
  # @route PUT /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements/:id (theme_presentation_element)
  def update
    authorize presentation_element
  ...
  # @route DELETE /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/:presentation_slug/elements/:id (theme_presentation_element)
  def destroy
    authorize presentation_element
