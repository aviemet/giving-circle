class Presentation::DistributionsController < ApplicationController
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions (theme_presentation_distributions)
  def index
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions/:id (theme_presentation_distribution)
  def show
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions/new (new_theme_presentation_distribution)
  def new
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions/:id/edit (edit_theme_presentation_distribution)
  def edit
    authorize presentation_distribution
  ...
  # @route POST /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions (theme_presentation_distributions)
  def create
    authorize Presentation::Distribution.new
  ...
  # @route PATCH /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions/:id (theme_presentation_distribution)
  # @route PUT /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions/:id (theme_presentation_distribution)
  def update
    authorize presentation_distribution
  ...
  # @route DELETE /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/presentation_distributions/:id (theme_presentation_distribution)
  def destroy
    authorize presentation_distribution
