class Presentation::VotesController < ApplicationController
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes (theme_presentation_votes)
  def index
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes/:id (theme_presentation_vote)
  def show
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes/new (new_theme_presentation_vote)
  def new
  ...
  # @route GET /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes/:id/edit (edit_theme_presentation_vote)
  def edit
    authorize presentation_vote
  ...
  # @route POST /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes (theme_presentation_votes)
  def create
    authorize Presentation::Vote.new
  ...
  # @route PATCH /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes/:id (theme_presentation_vote)
  # @route PUT /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes/:id (theme_presentation_vote)
  def update
    authorize presentation_vote
  ...
  # @route DELETE /:circle_slug/themes/:theme_slug/presentations/:presentation_slug/votes/:id (theme_presentation_vote)
  def destroy
    authorize presentation_vote
