...
if rspec_files.length == 1 && rspec_files[0] == "spec"
  SimpleCov.start "rails" do
    ...
    skip "/config/"
    skip "/vendor/"
    skip "app/controllers/concerns/active_circle_tracker.rb"
    skip "app/controllers/pages_controller.rb"
    skip "app/models/concerns/contactable.rb"
    skip "app/models/concerns/renderable.rb"
    skip "lib/url_params_json.rb"
