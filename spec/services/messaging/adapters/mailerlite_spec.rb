...
RSpec.describe Messaging::Adapters::Mailerlite do
  it "maps provider responses into batch outcomes" do
    integration = create(:integration, :mailerlite)
    ...
    response = instance_double(Net::HTTPSuccess, body: { data: { id: 99, status: "draft" } }.to_json, code: "201")
    ...
    expect(outcome.provider_message_id).to eq("99")
  end
end
