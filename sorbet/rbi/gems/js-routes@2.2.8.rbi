...
class JsRoutes::Generators::Base < ::Rails::Generators::Base
  ...
  # source://js-routes//lib/js_routes/generators/base.rb#8
...
class JsRoutes::Generators::Middleware < ::JsRoutes::Generators::Base
  ...
  # source://js-routes//lib/js_routes/generators/middleware.rb#46
  def gitignore_content; end

  # source://js-routes//lib/js_routes/generators/middleware.rb#28
  def middleware_content; end

  # source://js-routes//lib/js_routes/generators/middleware.rb#21
  def pack_content; end

  # source://js-routes//lib/js_routes/generators/middleware.rb#37
...
class JsRoutes::Generators::Webpacker < ::Rails::Generators::Base
  ...
  # source://js-routes//lib/js_routes/generators/webpacker.rb#28
  def loader_content; end

  # source://js-routes//lib/js_routes/generators/webpacker.rb#21
  def pack_content; end
end
...
class JsRoutes::Route
  ...
  # source://js-routes//lib/js_routes/route.rb#47
  ...
  # source://js-routes//lib/js_routes/route.rb#144
  def apply_case(*values); end

  # source://js-routes//lib/js_routes/route.rb#60
  def arguments(absolute); end

  # source://js-routes//lib/js_routes/route.rb#110
  def base_arguments; end

  # source://js-routes//lib/js_routes/route.rb#68
  def base_name; end

  # source://js-routes//lib/js_routes/route.rb#90
  def documentation; end

  # source://js-routes//lib/js_routes/route.rb#134
  def documentation_params; end

  # source://js-routes//lib/js_routes/route.rb#85
  def helper_name(absolute); end

  # source://js-routes//lib/js_routes/route.rb#81
  def json(value); end

  # @return [Boolean]
  #
  # source://js-routes//lib/js_routes/route.rb#140
  def match?(matchers); end

  # @return [Boolean]
  #
  # source://js-routes//lib/js_routes/route.rb#64
  def match_configuration?; end

  # source://js-routes//lib/js_routes/route.rb#106
  def optional_parts; end

  # source://js-routes//lib/js_routes/route.rb#73
  def parent_spec; end

  # source://js-routes//lib/js_routes/route.rb#114
  def parts_table; end

  # source://js-routes//lib/js_routes/route.rb#102
  ...
  # source://js-routes//lib/js_routes/route.rb#171
  def serialize_spec(spec, parent_spec = T.unsafe(nil)); end

  # source://js-routes//lib/js_routes/route.rb#77
  def spec; end
end
