...
class ActionMailer::Base < ::AbstractController::Base
  ...
  extend ::DecentExposure::Controller::ClassMethods
  ...
  # source://decent_exposure/3.0.4/lib/decent_exposure/mailer.rb#5
  def params; end
  ...
  # source://decent_exposure/3.0.4/lib/decent_exposure/mailer.rb#7
  ...
  class << self
    ...
    # source://decent_exposure/3.0.4/lib/decent_exposure/controller.rb#6
