...
#
# source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#18
class ActiveJob::QueueAdapters::DelayedJobAdapter
  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#19
  def enqueue(job); end

  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#25
  def enqueue_at(job, timestamp); end
end

# source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#31
class ActiveJob::QueueAdapters::DelayedJobAdapter::JobWrapper
  # @return [JobWrapper] a new instance of JobWrapper
  #
  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#34
  def initialize(job_data); end

  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#38
  def display_name; end

  # Returns the value of attribute job_data.
  #
  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#32
  def job_data; end
  ...
  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#46
  def perform; end
  ...
  # @return [Boolean]
  #
  # source://activejob//lib/active_job/queue_adapters/delayed_job_adapter.rb#51
  def log_arguments?; end
end
